...
import UseLanguages from '../charts/UseLanguages'
...
const UserProfile = ({ userName }: UserProfileProps) => {
  ...
  const { avatarUrl, name, bio, url, repositories, followers, following,gists } =
    data.user
    ...
    <div>
...

     {
      repositories.totalCount > 0 &&  (<div className='grid md:grid-cols-2 gap-4'>
        <UseLanguages repositories={repositories.nodes}/>
